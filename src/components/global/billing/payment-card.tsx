...
const PaymentCard = ({ current, landing, label }: Props) => {
  return (
    <div
      className={cn(
        label !== current
    ...
    >
      ...
      >
        ...
        {label === 'PRO' ? (
          <span
            className={
              'bg-gradient-to-r text-3xl from-indigo-500 via-purple-500 font-bold to-pink-500 bg-clip-text text-transparent'
            }
          >
            Smart AI
          </span>
        ...
        {landing ? (
          ...
          <Button
            className={
              'rounded-full mt-5 bg-background-80 text-white hover:text-background-80'
            }
